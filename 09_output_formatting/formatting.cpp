...
int main()
{
    ...
    std::cout << "LeBron James" << " 6" << std::endl;
    std::cout << "Dwayne Wade" << " 3" << std::endl;
    std::cout << "Udonis Haslem" << " 40" << std::endl;
    std::cout << "Chris Bosh" << " 1" << std::endl;
    std::cout << "Ray Allen" << " 34" << std::endl;
